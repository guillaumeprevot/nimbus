...
-----------|------|---------|---------|---------
[Nimbus Java API](https://github.com/guillaumeprevot/nimbus-java-api) | Java | [1.14](https://github.com/guillaumeprevot/nimbus-java-api/releases) | MIT | Routing API
[Jetty](https://www.eclipse.org/jetty/) | Java | [11.0.20](https://www.eclipse.org/jetty/download.html) | Apache 2.0 / EPL 1.0 | Serveur Web
...
[PostgreSQL](https://jdbc.postgresql.org/download.html) | Java | [42.7.2](https://search.maven.org/artifact/org.postgresql/postgresql) | BSD-2 | Persistance
[Commons DBCP](https://commons.apache.org/proper/commons-dbcp/) | Java | [2.11.0](https://commons.apache.org/proper/commons-dbcp/download_dbcp.cgi) | Apache 2.0 | Pool pour PostgreSQL
[Commons IO](https://commons.apache.org/proper/commons-io/) | Java | [2.15.1](https://commons.apache.org/proper/commons-io/download_io.cgi) | Apache 2.0 | Utilitaire
[PDFBox](https://pdfbox.apache.org/) | plugin Java | [2.0.30](https://pdfbox.apache.org/) | Apache 2.0 | Support des fichiers PDF
...
[JJWT](https://github.com/jwtk/jjwt) | transitive | [0.12.5](https://github.com/jwtk/jjwt/releases) | MIT | Support des JSON Web Token (JWT)
