...
-----------|------|---------|---------|---------
[Nimbus Java API](https://github.com/guillaumeprevot/nimbus-java-api) | Java | [1.18](https://github.com/guillaumeprevot/nimbus-java-api/releases) | MIT | Routing API
[Jetty](https://www.eclipse.org/jetty/) | Java | [11.0.25](https://www.eclipse.org/jetty/download.html) | Apache 2.0 / EPL 1.0 | Serveur Web
...
[Gson](https://github.com/google/gson) | Java | [2.13.1](https://github.com/google/gson/releases) | Apache 2.0 | Support du format JSON
[SLF4J](http://www.slf4j.org/) | Java | [2.0.17](http://www.slf4j.org/download.html) | MIT | Gestion des logs
[PostgreSQL](https://jdbc.postgresql.org/download.html) | Java | [42.7.7](https://search.maven.org/artifact/org.postgresql/postgresql) | BSD-2 | Persistance
...
[Commons IO](https://commons.apache.org/proper/commons-io/) | Java | [2.19.0](https://commons.apache.org/proper/commons-io/download_io.cgi) | Apache 2.0 | Utilitaire
[PDFBox](https://pdfbox.apache.org/) | plugin Java | [3.0.5](https://pdfbox.apache.org/) | Apache 2.0 | Support des fichiers PDF
...
[Commons Imaging](https://commons.apache.org/proper/commons-imaging/) | plugin Java | [1.1.0-alpha6](https://commons.apache.org/proper/commons-imaging/download_imaging.cgi) |  Apache 2.0 | Support des fichiers ICO
[Image4j](http://image4j.sourceforge.net/) | plugin Java | [0.7](https://github.com/imcdonagh/image4j) | LGPL | Support des fichiers ICO et BMP
...
[JAudiotagger](http://www.jthink.net/jaudiotagger/) | plugin Java | [3.0.1](https://dl.bintray.com/ijabz/maven/net/jthink/jaudiotagger/) | LGPL | Support des fichiers MP3, MP4, OGG, FLAC, WAV, AIF, Dsf, Wma
...
[JJWT](https://github.com/jwtk/jjwt) | transitive | [0.12.6](https://github.com/jwtk/jjwt/releases) | MIT | Support des JSON Web Token (JWT)
[Bouncy Castle](https://www.bouncycastle.org/java.html) | transitive | [1.81](https://www.bouncycastle.org/latest_releases.html) | MIT | Dépendance de PDFBox, comme iTextPDF, pour certains documents
...
[Lato](https://fonts.google.com/specimen/Lato) | transitive | [v23](https://fonts.googleapis.com/css2?family=Lato:ital,wght@0,300;0,400;0,700;1,400&display=swap) | OFL | WebFont pour les thèmes Flatly et Darkly
[JSZip](https://github.com/Stuk/jszip) | transitive | [3.10.0](https://github.com/Stuk/jszip/releases) | MIT or GPLv3 | Dépendances de ePub.js
...
```bash
# Linux
java -cp ./bin:./lib/*:./lib/javazoom/*:./lib/jave/* fr.techgp.nimbus.Application
# Windows
java -cp .\bin;.\lib\*;.\lib\javazoom\*;.\lib\jave\* fr.techgp.nimbus.Application
```
