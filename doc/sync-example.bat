...
java -cp %NIMBUS_HOME%\bin;%NIMBUS_HOME%\lib\commons-io-2.6.jar;%NIMBUS_HOME%\lib\gson-2.8.5.jar -Dnimbus.log=%LOG_FILE% -Dnimbus.conf=%CONF_FILE% fr.techgp.nimbus.sync.SyncMain %NIMBUS_ARGS%
pause
