	...
	NIMBUS.plugins.add({
		...
		langs: {
			fr: {
				...
				CalendarSave: "Sauvegarder mes modifications (Ctrl+S)",
				CalendarSelectDate: "Choisir une date",
				CalendarPreviousPeriod: "Période précédente (PagePréc. ou glisser à droite)",
				CalendarNextPeriod: "Période suivante (PageSuiv. ou glisser à gauche)",
				...
				CalendarSearch: "Rechercher (Ctrl+F)",
			...
			en: {
				...
				CalendarSave: "Save modifications (Ctrl+S)",
				CalendarSelectDate: "Select date",
				CalendarPreviousPeriod: "Previous period (PageUp or swipe right)",
				CalendarNextPeriod: "Next period (PageDown or swipe left)",
