	...
	NIMBUS.plugins.add({
		...
		langs: {
			fr: {
				...
				ContactsSearchTitle: "Rechercher des contacts (favoris) par noms, société, mot-clef, commentaire, email, numéro ou URL",
			...
			en: {
				...
				ContactsSearchTitle: "Search (favorite) contacts by name, company, keyword, note, email, number or link",
