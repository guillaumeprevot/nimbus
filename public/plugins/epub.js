	...
	NIMBUS.plugins.add({
		...
		langs: {
			fr: {
				...
				EPUBPreviousPage: "Afficher la page précédente (PagePréc. ou ← ou glisser à droite)",
				EPUBNextPage: "Afficher la page suivante (PageSuiv. ou → ou glisser à gauche)",
			...
			en: {
				...
				EPUBPreviousPage: "Show previous page (PageUp or ← or swipe right)",
				EPUBNextPage: "Show next page (PageDown or → or swipe left)",
				EPUBPosition: "Position",
